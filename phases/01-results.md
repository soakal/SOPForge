...
- First launch after build: 3.126s (one-time cost — see scripts/verify_exe.py's module docstring; matches an OS-level scan of a binary it hasn't seen before, not app or packaging behavior)
- Steady-state launches (3 repeats): 1.141s, 1.128s, 1.133s (average 1.134s, threshold 2.0s)
